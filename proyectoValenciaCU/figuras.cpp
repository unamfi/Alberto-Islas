...
void CFiguras::esfera2(GLfloat r,GLint merid, GLint par,GLuint text)
{
	...
	for(int i=0;i<par/2;i++)
	{
		...
		{
			glBegin(GL_QUADS);
			glTexCoord2f(2*j/(1.0*merid)+rep,1-(2.0*i)/par);
			glVertex3f(r*sin(2*3.141592*(i)/par)*cos(2*3.141592*(j)/merid),r*cos(i*2*3.141592/par),r*sin(2*3.141592*(i)/par)*sin(2*3.141592*(j)/merid));	
			
			glTexCoord2f(2*(j+1)/(1.0*merid)+rep,1-(2.0*i)/par);
			glVertex3f(r*sin(2*3.141592*(i)/par)*cos(2*3.141592*(j+1)/merid),r*cos((i)*2*3.141592/par),r*sin(2*3.141592*(i)/par)*sin(2*3.141592*(j+1)/merid));

			glTexCoord2f(rep+2*(1.0*(j+1))/merid,1-2*(i+1)/(1.0*par));
			glVertex3f(r*sin(2*3.141592*(i+1)/par)*cos(2*3.141592*(j+1)/merid),r*cos((i+1)*2*3.141592/par),r*sin(2*3.141592*(i+1)/par)*sin(2*3.141592*(j+1)/merid));

			glTexCoord2f(rep+2*(1.0*j)/merid,1-2*(i+1)/(1.0*par));
			glVertex3f(r*sin(2*3.141592*(i+1)/par)*cos(2*3.141592*(j)/merid),r*cos((i+1)*2*3.141592/par),r*sin(2*3.141592*(i+1)/par)*sin(2*3.141592*(j)/merid));
