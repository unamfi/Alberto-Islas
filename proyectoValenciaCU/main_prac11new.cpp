...
//NEW// Keyframes
//Dibujo o reproducir animacion
float posX =0, posY = 2.5, posZ =-3.5, rotRodIzq = 0,rotRodDer = 0;
float giroMonito = 0;
...
void animacion()
{
	...
	if(play) //Reproducir animacion con tecla L
	{		
		//Determinar cuando termina la animacion
		...
		else //Calculo de la interpolacion
		{
			...
			KeyFrame[playIndex].movBrazoDerInc=(KeyFrame[playIndex+1].movBrazoDer-KeyFrame[playIndex].movBrazoDer)/100;		//100 frames
			movBrazoDer += KeyFrame[playIndex].movBrazoDer;

			KeyFrame[playIndex].movBrazoIzqInc=(KeyFrame[playIndex+1].movBrazoIzq-KeyFrame[playIndex].movBrazoIzq)/100;		//100 frames
			movBrazoIzq += KeyFrame[playIndex].movBrazoIzq;

			KeyFrame[playIndex].rotInc=(KeyFrame[playIndex+1].rotRodIzq-KeyFrame[playIndex].rotRodIzq)/100;		//100 frames

			KeyFrame[playIndex].rotInc1=(KeyFrame[playIndex+1].rotRodDer-KeyFrame[playIndex].rotRodDer)/100;		//100 frames
